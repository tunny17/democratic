      ...
      <div className="body-content">
        <div className="content1">
          <figure>
            ...
            <figcaption>Move.co, the top leading fintec <br /> company that operates in the state has pledge to donate drones to monitor the upcoming Kwara state governorship election. <br /> Lorem ipsum dolor sit amet consectetur, adipisicing elit.</figcaption>
